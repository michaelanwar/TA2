<!-- PAGE TITLE
    ================================================== -->
<header class="pt-5 py-md-4" style="background-image: none;">
    <div class="container text-center py-xl-2">
        <h1 class="display-4 fw-semi-bold mb-0"><?= $title ?></h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-scroll justify-content-center">
                ...
                <li class="breadcrumb-item">
                    <a class="text-gray-800" href="<?= base_url('siswa/pelajaran') ?>">
                        Pelajaran
                    </a>
                </li>
...
<!-- MAIN CONTENT================================================== -->
<section class="py-2 position-relative bg-white">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mb-6 mb-lg-">
                <div class="mb-8">
                    <h3 class="mb-5">Kurikulum</h3>
                    <h2>Pelajaran <?= $course->mapel->nama ?></h2> 
                    <div id="accordionCurriculum">
                        <?php if ($course->materi->count() > 0) { ?>
                            <!-- BAB INFO -->
                            <h5>Daftar materi</h5>
                            <div class="border rounded shadow mb-6 overflow-hidden">
                                <?php foreach ($course->materi as $key => $materiItem) : ?>
