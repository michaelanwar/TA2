<!-- PAGE TITLE
    ================================================== -->
<header class="py-4 py-md-4" style="background-image: none;">
    <div class="container text-center py-xl-2">
        <h1 class="display-4 fw-semi-bold mb-0">Pelajaran</h1>
...
<div class="container mb-6 mb-xl-8 z-index-2">
    <div class="d-xl-flex align-items-center">
        <p class="mb-xl-0">Total <span class="text-dark"><?= $mapels->count() ?> pelajaran</span></p>
        <div class="ms-xl-auto d-xl-flex flex-wrap">
            <div class="mb-4 mb-xl-0 ms-xl-6">
                <form class="">
                    <div class="input-group input-group-filter">
                        <input id="searchBtn" class="form-control form-control-sm placeholder-dark border-end-0 shadow-none" type="search" required placeholder="Cari pelajaran" aria-label="Search">
...
<div class="container pb-4 pb-xl-7">
    ...
    <div class="row row-cols-md-2 row-cols-xl-3 mb-6 mb-xl-3">
        <?php foreach ($mapelList as $key => $mapel) : ?>
            <div class=" content col-md pb-4 pb-md-7">
                <!-- Card -->
